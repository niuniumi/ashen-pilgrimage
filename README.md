...
[在线试玩](https://niuniumi.github.io/ashen-pilgrimage/) | 当前版本 `v1.1.1-production`
...
- v3 存档、旧版地图无损迁移、损坏路线自修复、战斗断点续局和单次结算保护。
- 8 条场景 BGM、50 个多样本效果音、统一响度与淡入淡出混音。
- 打击停顿、受击爆点、卡牌飞行、首领转阶段和失败结算动效。
...
主要报告位于 `qa/`。音频来源和许可证见 [音频素材清单](docs/AUDIO_ASSET_MANIFEST.md)，版本变更见 [v1.1 发布说明](docs/RELEASE_NOTES_1.1.md)。
